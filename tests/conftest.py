...
REFERENCE_VARIABLES = [
    ...
    "DDT Accumulated Insects",
    "Gecko Population",
    "DDT Accumulated Geckos",
    "Cat Population",
    "DDT Accumulated Cats",
    "Rat Population",
    "Plague Incidence",
    "Grain Store Level",
    "Cat Parachute Drops",
...
REFERENCE_LINKS = [
    ...
    CausalLink(source="DDT Spraying Level", target="DDT Accumulated Insects", polarity="+", has_delay=True),
    ...
    CausalLink(source="DDT Accumulated Insects", target="Gecko Population", polarity="-", has_delay=True),
    CausalLink(source="DDT Accumulated Insects", target="DDT Accumulated Geckos", polarity="+", has_delay=True),
    CausalLink(source="DDT Accumulated Geckos", target="Cat Population", polarity="-", has_delay=True),
